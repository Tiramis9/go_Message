...
import (
	...
	pb "rmcloud.exp/rmtaskmgt/api/gRPC-Gateway" // 引入编译生成的包
)
...
type managework struct {
}

// n\NewManageServe  HTTP服务
func managework() pb.ManageServeServer {
	return new(managework)
}

// SayHeManageMessagello 实现manage服务接口
func (m *managework) ManageMessage(ctx context.Context, in *pb.RmsmomRequest) (*pb.RmsmomReply, error) {
